...
object CatalogUtils {
  ...
  def normalizeBucketSpec(
    ...
    val BucketSpec(numBuckets, bucketColumnNames, sortColumnNames, bucketingType, minValue, maxValue) = bucketSpec
    ...
    BucketSpec(numBuckets, normalizedBucketCols, normalizedSortCols, bucketingType, minValue, maxValue)
  }
